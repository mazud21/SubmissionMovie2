...
public class FavWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.gmail.hmazud.submissionmovie2.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.gmail.hmazud.submissionmovie2.EXTRA_ITEM";
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setRemoteAdapter(R.id.stack_fav_view, intent);
        ...
        views.setPendingIntentTemplate(R.id.stack_fav_view, toastPendingIntent);
